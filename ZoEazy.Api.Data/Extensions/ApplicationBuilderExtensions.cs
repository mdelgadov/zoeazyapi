...
namespace ZoEazy.Api.Data.Extensions
{
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder AddCustomSecurityHeaders(this IApplicationBuilder app, string hostUrl, string stsAuthority)
        {
                   ...
                   .AddContentSecurityPolicy(builder =>
                    {
                        ...
                        var socketUrl = hostUrl.Replace("http://", "ws://", StringComparison.OrdinalIgnoreCase).Replace("https://", "wss://", StringComparison.OrdinalIgnoreCase);
